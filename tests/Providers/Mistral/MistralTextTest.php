...
describe('Text generation', function (): void {
    ...
    it('stops execution when approval-required tool is called (Phase 1)', function (): void {
        FixtureResponse::fakeResponseSequence('v1/chat/completions', 'mistral/text-with-approval-tool');
    ...
    it('executes approved tool and continues to LLM response (Phase 2)', function (): void {
        FixtureResponse::fakeResponseSequence('v1/chat/completions', 'mistral/text-with-approval-phase2');
