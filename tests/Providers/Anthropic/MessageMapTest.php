...
describe('Anthropic server tool calls mapping', function (): void {
    it('maps assistant message with server tool calls', function (): void {
        expect(MessageMap::map([
            new AssistantMessage(
                content: 'I have used a server tool.',
                additionalContent: [
                    'server_tool_calls' => [
                        [
            ...
            [
                ...
                'content' => [
                    [
                        'type' => 'text',
                        'text' => 'I have used a server tool.',
                    ],
                    [
                        'type' => 'server_tool_use',
                        'id' => 'srvtoolu_xyz789',
