...
class LogDriver implements Telemetry
{
    ...
    {
        // For the log driver, child spans are handled the same as regular spans
    ...
    protected function logSpanStart(string $spanName, string $spanId, array $attributes, float $startTime): void
    {
        ...
        Log::channel($this->channel)->info("Prism span started: {$spanName}", $context);
    }
