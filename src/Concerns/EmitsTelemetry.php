...
trait EmitsTelemetry
{
     ...
     * @param  class-string|null  $startEventType  Event type to trigger start telemetry (null = dispatch before generator)
     * @param  class-string|null  $endEventType  Event type to trigger end telemetry (null = dispatch after generator)
